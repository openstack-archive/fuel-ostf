...
Revision ID: 2e81ed3c415
Revises: None
Create Date: 2013-12-19 17:17:40.127259

"""

# revision identifiers, used by Alembic.
revision = '2e81ed3c415'
down_revision = None
...
### commands auto generated by Alembic - please adjust! ###
    ...
    op.create_table('cluster_testing_pattern',
    sa.Column('cluster_id', sa.Integer(), nullable=False),
    sa.Column('test_set_id', sa.String(length=128), nullable=False),
    sa.Column('tests', postgresql.ARRAY(sa.String(length=512)), nullable=True),
    ...
    sa.Column('status', sa.Enum('running', 'deffered', 'finished', name='test_run_states'), nullable=False),
    sa.Column('meta', fields.JsonField(), nullable=True),
    sa.Column('started_at', sa.DateTime(), nullable=True),
    sa.Column('ended_at', sa.DateTime(), nullable=True),
    sa.Column('test_set_id', sa.String(length=128), nullable=True),
    sa.Column('cluster_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['test_set_id', 'cluster_id'], ['cluster_testing_pattern.test_set_id', 'cluster_testing_pattern.cluster_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('wait_running', 'running', 'failure', 'success', 'error', 'stopped', 'disabled', 'skipped', name='test_states'), nullable=True),
