...
def upgrade():
    op.add_column('test_sets', sa.Column('available_from_release',
                                         sa.String(64),
                                         default=""))
    op.add_column('tests', sa.Column('available_from_release',
                                     sa.String(64),
                                     default=""))
...
def downgrade():
    op.drop_column('test_sets', 'available_from_release')
    op.drop_column('tests', 'available_from_release')
