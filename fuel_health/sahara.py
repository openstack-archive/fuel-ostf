...
class SaharaManager(nmanager.PlatformServicesBaseClass):
    ...
    def setUp(self):
        ...
        # Create a flavor for Sahara tests.
        self.flavor_id = self._create_sahara_flavor()

    # Method for creating a flavor for Sahara tests.
    def _create_sahara_flavor(self, ram=2048, vcpus=1, disk=20):
    ...
    def find_and_check_image(self, tag_plugin_name, tag_hadoop_version):
        """This method finds a correct image for Sahara tests.

        It finds a Sahara image by specified tags and checks whether the image
    ...
    def _find_image_by_tags(self, tag_plugin_name, tag_hadoop_version):
        """This method finds a Sahara image by specified tags."""
    ...
    def delete_resources(self, resources,
        ...
        for resource in resources[:]:
            try:
                ...
                self.fail(
                    'Failed while deleting one of the resources. ' + str(e))
    ...
    def _delete_timeout(self, resource_client, resource):
        ...
        self.fail('Request timed out. Timed out while waiting for one '
                  'of the resources to delete within %d seconds.' % timeout)
