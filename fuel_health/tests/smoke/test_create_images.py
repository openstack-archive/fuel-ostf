...
class GlanceSmokeTests(glance.GlanceTest):
    ...
    def test_create_and_delete_image(self):
        ...
        Scenario:
            ...
            3.Check that image created successfully
            4.Update image with properties
            5.Check properties updated successfully
            6.Delete image
        Duration: 180 s.
        """
        ...
        fail_msg = "Image status incorrect. Please, check your " \
    ...
    def test_create_and_delete_image_v2(self):
        ...
        fail_msg = "Image status incorrect. Please refer to logs"
