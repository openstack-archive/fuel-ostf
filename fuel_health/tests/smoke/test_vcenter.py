...
class VcenterVolumesTest(nmanager.SmokeChecksTest):
    ...
    def setUp(self):
        ...
        self.check_clients_state()
        if (not self.config.volume.cinder-vmware_node_exist):
    ...
    def test_6_vcenter_create_boot_volume(self):
        """vCenter: Create volume and boot instance from it
        Target component: Compute
