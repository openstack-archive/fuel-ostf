...
class TestNeutronIPv6(neutronmanager.NeutronBaseTest):
    ...
    """
    def setUp(self):
        super(TestNeutronIPv6, self).setUp()
    ...
    def test_check_neutron_ipv6_connectivity(self):
        ...
        Scenario:
            ...
            13. Create an instance1 using the new security group
                in created network 1.
            14. Create an instance2 using the new security group
                in created network 2.
            15. Create a new floating IP (server1)
            16. Create a new floating IP (server2)
            17. Assign the new floating IP to the instance1.
            18. Assign the new floating IP to the instance2.
            19. Check connectivity to the instance1 using ping command.
            20. Check connectivity to the instance2 using ping command.
            ...
            27. Delete instance2.
            28. Remove router.
            29. Remove server1 v4 subnet
            30. Remove server1 v6 subnet
            31. Remove server2 v4 subnet
            32. Remove server2 v6 subnet
            33. Remove network 1
            34. Remove network 2
        ...
        name1 = rand_name('ost1_test-server1-smoke-ipv6-')
        name2 = rand_name('ost1_test-server2-smoke-ipv6-')
        ...
        subnet_1_v4 = self.verify(20, self.create_subnet_dynamic, 5,
                                  'Subnet v4 can not be created',
                                  'Subnet creation',
                                  network1, '192.168.100.0/24')

        subnet_1_v6 = self.verify(20, self.create_subnet_dynamic, 6,
                                  'Subnet v6 can not be created',
                                  'Subnet creation',
                                  network1,
                                  "2001:db8:100::/64", "2001:db8:100::1")

        subnet_2_v4 = self.verify(20, self.create_subnet_dynamic, 7,
                                  'Subnet v4 can not be created',
                                  'Subnet creation',
                                  network2, '192.168.200.0/24')

        subnet_2_v6 = self.verify(20, self.create_subnet_dynamic, 8,
                                  'Subnet v6 can not be created',
                                  'Subnet creation',
                                  network2,
        ...
        LOG.info(
            'instance1 floating IP address is {0}'.format(floating_ip1.ip))
        LOG.info('instance1 IPv6 address is {0}'.format(instance1_ipv6))
        LOG.info(
            'instance2 floating IP address is {0}'.format(floating_ip2.ip))
        LOG.info('instance2 IPv6 address is {0}'.format(instance2_ipv6))
        ...
        self.verify(600, self._check_connectivity_from_vm_v4v6, 21,
                    "Connectivity to the instance2 VM from the instance1 VM"
                    " via IPv6 doesn`t function properly.",
                    "Connectivity checking to the instance2 VM"
                    " from the instance1 VM via IPv6",
                    floating_ip1.ip, 30, (9, 60), instance2_ipv6)
