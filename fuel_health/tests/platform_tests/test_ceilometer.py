...
class CeilometerApiPlatformTests(ceilometermanager.CeilometerBaseTest):
    ...
    def test_check_alarm_state(self):
        ...
        Scenario:
            ...
            2. Wait for active status of instance.
            3. Get Nova notifications.
            4. Get Nova pollsters.
            5. Get Nova statistic.
            6. Create a new alarm.
            7. Verify that alarm status is 'alarm' or 'ok'.
        ...
        fail_msg = 'Failed to get Nova notifications.'
        msg = 'getting Nova notifications'
        ...
        fail_msg = 'Failed to get Nova pollsters.'
        msg = 'getting Nova pollsters'
        self.verify(600, self.wait_metrics, 4, fail_msg, msg, pollsters, query)

        fail_msg = 'Failed to get Nova statistic (notification:cpu_util).'
        msg = 'getting Nova statistic (notification:cpu_util)'
        ...
        fail_msg = ('Failed to create alarm for '
                    'Nova summary statistic (notification:cpu_util).')
        msg = ('creating alarm '
               'for Nova summary statistic (notification:cpu_util)')
        ...
        fail_msg = ('Failed while waiting for '
                    'alarm status to become "alarm" or "ok".')
        msg = 'waiting for alarm status to become "alarm" or "ok"'
    ...
    def test_create_sample(self):
        ...
        Scenario:
        1. Request list of samples for an image.
        ...
        fail_msg = ('Resource of sample is missing or '
                    'not equal to the expected resource.')
    ...
    def test_check_volume_notifications(self):
        ...
        if (not self.config.volume.cinder_node_exist
            ...
            self.skipTest('There is no Cinder or Ceph storage for volumes.')
    ...
    def test_check_keystone_notifications(self):
        ...
        tenant, user, role, group, trust = self.verify(600,
