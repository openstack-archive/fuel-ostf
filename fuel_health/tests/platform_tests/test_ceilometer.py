...
class CeilometerApiPlatformTests(ceilometermanager.CeilometerBaseTest):
    ...
    def test_check_keystone_notifications(self):
        ...
        tenant, user, role, group = self.identity_helper()
        ...
        # fail_msg = "Keystone role assignment notifications are not received."
        # msg = "Keystone role assignment notifications are received."
