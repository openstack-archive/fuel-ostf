...
class ClusterTest(sahara.SaharaManager):
...
class VanillaClusterTest(ClusterTest):
    ...
    def setUp(self):
        ...
        self.processes_map = {
            ...
            'oozie': [11000],
            'historyserver': [10020, 19888]
        }

        floating_ip_pool, net_id = self.get_network_info()
        self.cl_template = {
    ...
    def test_vanilla_cluster(self):
        ...
        Scenario:
            ...
            4. Checking Hadoop services on cluster
