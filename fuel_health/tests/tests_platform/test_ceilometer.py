...
class CeilometerApiPlatformTests(ceilometermanager.CeilometerBaseTest):
    ...
    def test_check_swift_metrics(self):
        ...
        5. If RadosGW option for Swift is disabled, get object notifications.
        ...
        object_pollsters = (self.radosgw_object_pollsters if object_ceph
                            else self.swift_object_pollsters)
        ...
        container_pollsters = (self.radosgw_container_pollsters if object_ceph
                               else self.swift_container_pollsters)
