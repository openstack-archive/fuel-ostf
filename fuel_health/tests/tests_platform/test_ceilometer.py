...
class CeilometerApiPlatformTests(ceilometermanager.CeilometerBaseTest):
    ...
    def test_check_volume_notifications(self):
        ...
        self.verify(300, self.volume_helper, 5,
                    fail_msg, msg, volume, instance)

        fail_msg = 'Failed to create snapshot.'
        msg = 'creating snapshot'
        snapshot = self.verify(120, self.snapshot_helper, 6,
                               fail_msg, msg, volume)
        ...
        self.verify(300, self.wait_metrics, 7,
                    fail_msg, msg,
