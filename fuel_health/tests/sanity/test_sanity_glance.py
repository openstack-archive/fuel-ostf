...
class GlanceSanityTests(glance.GlanceTest):
    """
    TestClass contains verifications of basic Glance functionality.
    """
    ...
    def test_glance_image_list(self):
        ...
        self.verify_response_true(image_list_resp,
                                  "Step 2 failed: "
                                  "{msg}".format(msg=fail_msg), 2)
